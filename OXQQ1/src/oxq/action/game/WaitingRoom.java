...
//				new GameWindow(dto, room).service(this);
			}
		} else { // 비밀번호 있는 방
...
//					MemberDTO memberDTO = memberDAO.loginDTO(id);
//					RoomDTO roomDTO = roomdao.getRoomInfo(roomName);
//					PlayInfoDTO dto = (PlayInfoDTO) obj;
					
					System.out.println("WaitingRoom에서 PlayInfoDTO");
					
//					new GameWindow(memberDTO.getNickName(), roomName).service(this);
...
//				
//				PlayInfoDTO playInfoDTO = new PlayInfoDTO(); // 게임방에 참가한 플레이어의 dto
//				playInfoDTO.setCommand(PlayInfo.JOIN);
//				playInfoDTO.setNickname(nickName);
//				new GameWindow(nickName, roomName);
////				RoomDTO roomDTO = roomdao.getRoomInfo(roomName);
